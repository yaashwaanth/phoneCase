...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(
  ({ className, variant,isLoading,loadingText, size,children, asChild = false, ...props }, ref) => {
    ...
    return (
      ...
      >
       ...
       {isLoading ? (<span className="ml-1.5 flex items-center gap-1">
        ...
        <span className=" delay-200 animate-flashing w-1 h-1 bg-white rounded-full inline-block"/>
